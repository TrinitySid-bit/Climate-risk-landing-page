    ...
    <div className="bg-amber-50 border-b-2 border-amber-200">
      <div className="max-w-7xl mx-auto px-4 py-3 text-center">
        <p className="text-sm text-amber-900">
          ...
          We do not provide insurance quotes or financial advice. Scores are based on publicly available data. 
          It is the responsibility of the purchaser to review the primary data sources we aggregate from. 
          Always conduct proper due diligence and obtain professional insurance quotes before making property decisions.
          {' '}
