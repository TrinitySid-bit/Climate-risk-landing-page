    ...
    <main className="min-h-screen" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-5">
              ...
              <p className="text-slate-600 text-sm">"We checked three properties before buying. NestCheck showed us which had the lowest risk. Best $40 we ever spent."</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 px-4 md:px-6 bg-white" id="pricing">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-slate-500">One property, one price. No subscriptions.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {/* Basic */}
            <div className="bg-white border-2 border-slate-200 rounded-2xl p-6">
              <div className="text-slate-500 font-bold text-sm uppercase mb-1">Basic Report</div>
              <div className="text-4xl font-extrabold text-[#0c1929] mb-1">$29.99</div>
              <p className="text-slate-500 text-sm mb-5">Climate risk and property analysis</p>
              
              <ul className="space-y-2 mb-6 text-sm text-slate-600">
                <li><span className="text-[#22c55e] font-bold">✓</span> Climate Risk Scores</li>
                <li><span className="text-[#22c55e] font-bold">✓</span> 25+ Planning Overlays</li>
                <li><span className="text-[#22c55e] font-bold">✓</span> Schools, Hospitals, Transport</li>
            ...
            <div className="bg-white border-2 border-[#22c55e] rounded-2xl p-6 relative shadow-lg">
              ...
              <div className="text-4xl font-extrabold text-[#0c1929] mb-1">$39.99</div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4 text-xs text-green-800">
                <strong>Why Premium?</strong> Crime data reveals what photos can't. Make sure your family is safe.
              </div>
              ...
              <p className="text-center text-slate-500 text-xs mt-3">Most popular — only $10 more</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "How much crime data do you have?", a: "10 years of crime statistics from Crime Statistics Agency Victoria. Premium reports show trends and category breakdowns." },
              { q: "Why get Premium instead of Basic?", a: "Premium adds crime and safety analysis — something photos can't show you. See if burglary is increasing, how safe the suburb really is. Only $10 more." },
      ...
      <section className="py-12 px-4 md:px-6 bg-[#0c1929]">
        <div className="max-w-xl mx-auto text-center">
          ...
          <form onSubmit={(e) => { e.preventDefault(); openCheckout(address); }} className="mb-4">
            <div className="flex flex-col sm:flex-row bg-white rounded-xl overflow-hidden shadow-2xl">
              <input
                type="text"
                value={address}
                onChange={(e) => setAddress(e.target.value)}
                placeholder="Enter any Victorian address..."
                className="flex-1 px-5 py-4 text-base text-slate-800 placeholder-slate-400 border-none outline-none"
              />
              <button type="submit" className="bg-[#22c55e] text-white px-6 py-4 font-bold hover:bg-[#16a34a] transition whitespace-nowrap sm:m-1.5 sm:rounded-lg">
                Get Report
              </button>
